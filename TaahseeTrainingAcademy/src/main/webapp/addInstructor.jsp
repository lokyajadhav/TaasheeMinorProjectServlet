...
<html lang="en">
  ...
  <body>
    ...
    <form action="addInstructor" method="post" class="mx-auto p-5 mx-auto mt-5 shadow-sm p-3 mb-5 bg-body-tertiary rounded" style="width: 600px">
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Instructor userName</label>
